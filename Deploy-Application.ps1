...
Try {
	...
	[string]$appVendor = 'TCP Software'
	[string]$appName = 'Aladtec'
	[string]$appVersion = '1.0.0'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '2022.11.02'
	...
	$64bitAppInstallName = "Aladtec"
	# Application install Path.
	$64bitAppInstallPath = "${Env:ProgramFiles}\Tuolumne County\Aladtec"

	##* Application uninstall parameters.
	# 64-bit application
	# 64-bit application uninstall name.
	$64bitAppUninstallName = "Aladtec"
	...
	[string[]]$appShortcutDirs = @("${Env:ProgramFiles}\Tuolumne County\Aladtec", "${Env:ProgramData}\Microsoft\Windows\Start Menu\Programs", "${Env:PUBLIC}\Desktop")
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Foreach ($appShortcutDir in $appShortcutDirs) {
			Try {
				...
				New-Shortcut -Path "$appShortcutDir\$64bitAppInstallName.lnk" -TargetPath "CONFIDENTIAL" -IconLocation "$64bitAppInstallPath\Assets\aladtec_rLs_icon.ico" -WindowStyle "Maximized" -Description "Aladtec"
			}
